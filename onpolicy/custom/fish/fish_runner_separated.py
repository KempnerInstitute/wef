...
class MAFishRunner(Runner):
                    ...
                    for info in infos:
                        for count, info in enumerate(infos):
                            if "individual_reward" in infos[count][agent_id].keys():
                                idv_rews.append(
                                    infos[count][agent_id].get("individual_reward", 0)
                                )
    ...
    def collect(self, step):
        ...
        for agent_id in range(self.num_agents):
            ...
            action_env = action.copy()  # TODO: Differs from MPE (Not implemented there)
    ...
    def insert(self, data):
        ...
        for agent_id in range(self.num_agents):
            ...
            self.buffer[agent_id].insert(
                ...
                values[:, agent_id],
                # rewards[:, agent_id], # TODO: MPE
                np.expand_dims(rewards[:, agent_id], axis=-1),  # TODO: Hacky fix
                masks[:, agent_id],
                bad_masks=None,
                active_masks=None,
    ...
    def eval(self, total_num_steps):
        ...
        for eval_step in range(self.episode_length):
            ...
            for agent_id in range(self.num_agents):
                ...
                # TODO: MPERunner has a "rearrange action" code here
    ...
    def render(self):
        ...
        if self.all_args.save_vids:
            self.vid_dir = "./"
            outfile = "./render_separated_MAFish.gif"
            imageio.mimsave(outfile, all_frames, duration=self.all_args.ifi)
            print("Saved", outfile)

            outfile = "render_separated_MAFish.pkl"
