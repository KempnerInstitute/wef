...
def get_config():
    ...
    Network parameters:
        ...
        --use_orthogonal
            by default False, use Orthogonal initialization for weights and 0 initialization for biases. or else, will use xavier uniform inilialization.
        --gain
    ...
    # env parameters
    parser.add_argument("--env_name", type=str, default='MultiAgentForagingEnv', help="specify the name of environment")
    ...
    # render parameters
    parser.add_argument("--save_vids", action='store_true', default=True, help="by default, do not save render video. If set, save video.")
    ...
    # parser.add_argument("--save_vids", action='store_true', default=False, help="by default, do not save render video. If set, save video.")
